...
<template>
  <div class="py-[5vh] px-[5vw]">
    <header>
      <nav>
        <ul
          class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-800 dark:border-gray-200 dark:text-gray-400"
        >
          <li class="me-2">
            <RouterLink
              to="/"
              ...
              activeClass="text-gray-600 bg-gray-200 dark:bg-gray-800 dark:text-gray-300"
            >
              Outside Calculator
            </RouterLink>
          </li>
