...
<template>
  <button
    ...
    :class="[
      selected
        ? 'text-green-800 dark:text-green-200 bg-green-200 dark:bg-green-800 border-green-800 dark:border-green-200'
        : 'text-gray-800 dark:text-gray-200 bg-gray-200 dark:bg-gray-800 border-gray-800 dark:border-gray-200',
      disabled ? 'cursor-not-allowed !bg-gray-400 !dark:bg-gray-600' : '',
      error
        ? '!text-red-800 !dark:text-red-200 !bg-red-200 !dark:bg-red-800 !border-red-800 !dark:border-red-200'
        : ''
    ]"
  >
    <span v-if="shape == 'C'">
